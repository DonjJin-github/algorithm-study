...
<details>
<summary>📁 <b>Silver</b> · 52문제</summary>
...
<details>
<summary>📁 <b>1. 입출력과 사칙연산</b> · 13문제</summary>
...
<details>
<summary>📁 <b>3. 반복문</b> · 12문제</summary>
...
<details>
<summary>📁 <b>4. 1차원 배열</b> · 10문제</summary>
...
<details>
<summary>📁 <b>5. 문자열</b> · 11문제</summary>
...
<details>
<summary>📁 <b>7. 2차원 배열</b> · 4문제</summary>
...
<details>
<summary>📁 <b>8. 일반 수학1</b> · 7문제</summary>
...
<details>
<summary>📁 <b>12. 브루트 포스</b> · 3문제</summary>
...
<details>
<summary>📁 <b>14. 집합과 맵</b> · 8문제</summary>
...
<details>
<summary>📁 <b>15. 조합론</b> · 5문제</summary>
...
<details>
<summary>📁 <b>18. 심화2</b> · 5문제</summary>
...
<details>
<summary>📁 <b>20. 백트래킹</b> · 6문제</summary>
...
<details>
<summary>📁 <b>Level 3</b> · 14문제</summary>
...
<details>
<summary><b>Trail2</b> · 47문제</summary>
...
| 2명의 도둑 | ✅ | 97ms | 9MB |
| 4가지 연산을 이용하여 1 만들기 | ✅ | 92ms | 9MB |
| K개 중에 1개를 N번 뽑기 | ✅ | 374ms | 23MB |
| K개의 벽 없애기 | ✅×2 | 97ms | 9MB |
| K번 최댓값으로 이동하기 | ✅ | 94ms | 9MB |
...
| 정수 사각형 최댓값의 최소 | ✅ | 166ms | 12MB |
| 정수 사각형 최소 합 | ✅ | 131ms | 10MB |
| 정수 사각형 최솟값의 최대 | ✅ | 87ms | 9MB |
| 최고의 33위치 | ✅ | 103ms | 9MB |
| 최대 감소 부분 수열 | ✅ | 118ms | 9MB |
| 최대 증가 부분 수열 | ✅ | 91ms | 9MB |
| 최소 경로로 탈출 하기 | ✅ | 93ms | 9MB |
| 최소 점프 횟수 | ✅ | 94ms | 9MB |
| 크기가 N인 순열 | ✅ | 327ms | 21MB |
| 트로미노 | ✅ | 93ms | 9MB |
| 특정 조건에 맞게 K개 중에 1개를 N번 뽑기 | ✅ | 380ms | 23MB |
| 피보나치 수 | ✅ | 102ms | 9MB |
| 행복한 수열의 개수 | ✅ | 111ms | 10MB |

</details>

<details>
<summary><b>Trail5</b> · 76문제</summary>
...
| 가장 오래 걸리는 학생 2 | ✅ | 532ms | 26MB |
| 각 정점까지의 최단 경로 | ✅ | 875ms | 42MB |
| 각 정점까지의 최단 경로 2 | ✅ | 385ms | 21MB |
| 각 정점까지의 최단 경로 3 | ✅ | 122ms | 10MB |
| 낮은 지점들 | ✅ | 464ms | 24MB |
| 단어장 | ✅ | 418ms | 22MB |
...
| 동전 더하기 | ✅ | 88ms | 9MB |
| 두 수의 합 | ✅×2 | 390ms | 22MB |
| 마지막으로 남은 숫자 | ✅ | 404ms | 19MB |
| 문제 추천 시스템 1 | ✅ | 492ms | 32MB |
| 배열 추출 | ✅ | 413ms | 30MB |
| 배열 추출 2 | ✅ | 525ms | 28MB |
| 부분 수열의 합이 K | ✅ | 118ms | 9MB |
| 비율 구하기 | ✅ | 337ms | 15MB |
| 삼 오 무 | ✅ | 91ms | 9MB |
| 서로 다른 수의 개수 | ✅ | 261ms | 19MB |
| 선분 위의 점 | ✅ | 847ms | 33MB |
| 세 수의 합 | ✅ | 1749ms | 181MB |
| 수 등장 횟수 | ✅ | 472ms | 23MB |
| 수 합치기 | ✅ | 362ms | 18MB |
...
| 숫자 빠르게 찾기 | ✅ | 390ms | 21MB |
| 숫자 빠르게 찾기 2 | ✅ | 530ms | 29MB |
| 앞에서부터 삭제하기 2 | ✅ | 651ms | 27MB |
| 연속 부분 합의 최댓값 구하기 2 | ✅ | 152ms | 12MB |
| 원소의 합이 0 | ✅ | 977ms | 59MB |
| 이동 가능한 점들의 쌍 | ✅ | 91ms | 9MB |
| 자리 바꾸기 2 | ✅ | 455ms | 36MB |
| 자리 차지하기 | ✅ | 522ms | 32MB |
| 자연수 n개의 합 | ✅ | 96ms | 9MB |
...
| 저렴한 모임 | ✅ | 143ms | 10MB |
| 점 빼기 | ✅ | 358ms | 22MB |
| 정수 N개의 합 2 | ✅ | 232ms | 20MB |
| 정수 N개의 합 3 | ✅×2 | 291ms | 21MB |
| 정수 명령 처리 6 | ✅ | 142ms | 11MB |
| 정수 명령어 | ✅ | 475ms | 28MB |
| 정수 분배하기 | ✅×3 | 102ms | 9MB |
| 정수 찾기 | ✅ | 459ms | 33MB |
| 좌우 반전시키기 | ✅×2 | 88ms | 9MB |
| 중앙값 | ✅ | 509ms | 30MB |
| 쪼개어 배낭 채우기 구현 | ✅ | 457ms | 21MB |
| 차이가 가장 작은 수 | ✅ | 597ms | 27MB |
| 처음 등장하는 위치 | ✅ | 166ms | 12MB |
| 초대장과 번호표 | ✅ | 719ms | 47MB |
| 최단 거리 | ✅ | 108ms | 9MB |
| 최단 거리 11 | ✅×2 | 500ms | 25MB |
| 최단 거리 3 | ✅ | 311ms | 22MB |
| 최단 거리 9 | ✅×2 | 546ms | 35MB |
| 최대 수 만들기 | ✅×2 | 1051ms | 81MB |
| 최대 숫자 구하기 | ✅ | 264ms | 15MB |
| 최대로 연속한 숫자 | ✅ | 1246ms | 41MB |
| 최소 정수 출력 | ✅ | 423ms | 31MB |
| 최솟값 3개 | ✅ | 397ms | 20MB |
| 친한 점 | ✅ | 452ms | 31MB |
| 큰 숫자만 계속 고르기 | ✅ | 438ms | 26MB |
| 특별한 문자 | ✅×2 | 393ms | 24MB |
...
<details>
<summary><b>Trail6</b> · 17문제</summary>
...
| 정점 연결하기 | ✅ | 368ms | 21MB |
| 집합의 원소 | ✅ | 409ms | 24MB |
| 최소 간선의 크기 | ✅ | 647ms | 33MB |
| 최소 스패닝 트리 | ✅ | 572ms | 27MB |
| 최소 스패닝 트리 4 | ✅ | 503ms | 24MB |
| 최소 스패닝 트리 8 | ✅ | 138ms | 10MB |
| 최소 스패닝 트리 9 | ✅ | 1093ms | 46MB |
| 친구의 키 | ✅ | 469ms | 26MB |
| 친구의 키 2 | ✅×2 | 394ms | 22MB |
| 친구의 키 3 | ✅ | 501ms | 25MB |
| 크기 비교 3 | ✅ | 572ms | 30MB |
| 트리 완성 | ✅×2 | 361ms | 21MB |
